...
[Script R – création BDD](Z:/0_Direction_des_Etudes\Base élève/analyse_bdd_eleves_ensai/scripts/creation_BDD.qmd){.button .blue-button}
...
La requête se nomme *« Scola - Extraction notes - Requête principale - Pour base élèves »*.  
...
La requête *« Scola - Extraction notes - Points de bonus et de jury - Pour base élèves »*  
