...
# Vérifie que renv est synchronisé
if (length(renv::status()$package) > 0) {
  stop("Projet renv non synchronisé. Exécutez renv::status() pour plus de détails.")
}

# Charge les packages (sans vérification redondante)
pkgs <- c(
  "arrow", "dplyr", "here", "DT", "scales",  # scales avant readr
  "readr", "readxl", "knitr", "kableExtra",
  "forcats", "tidyr", "ggplot2"
)
