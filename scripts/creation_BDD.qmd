...
[Requêtes SQL](Z:/0_Direction_des_Etudes\Base élève/analyse_bdd_eleves_ensai/scripts/requetes_SQL.qmd){.button .blue-button}
[Voir le dictionnaire des variables](Z:/0_Direction_des_Etudes\Base élève/analyse_bdd_eleves_ensai/scripts/dictionnaire.qmd){.button .green-button}
