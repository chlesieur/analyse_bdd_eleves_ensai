...
bdd <- read_parquet("Z:/0_Direction_des_Etudes/Base élève/data/bdd_2015_2024.parquet") %>% filter(annee_ecole != "Autres")
...
bdd_1A_2A_unique$bloc_an<- ifelse(bdd_1A_2A_unique$annee %in% c(2015,2016,2017),"2015-2017",ifelse (bdd_1A_2A_unique$annee %in% c(2018,2019,2020),"2018-2020",ifelse(bdd_1A_2A_unique$annee %in% c(2021,2022),"2021-2022","2023-2024")))
...
### 1.1 Nombre d'étudiants par année en 1A, 2A et 3A
